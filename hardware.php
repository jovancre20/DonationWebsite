...
<head>
    ...
    <title>Aid Alliance | Electronics donation</title>
...
<body>
   ...
   <!-- <div class="donate-home">
    ...
    <div class="titlediv">
        <h1 class="titlehead">Electronics Donaiton</h1>
    </div>

    <section>
        <div class="donate-class">

            <form action="catogories-function/electronicfunction.php" method="post">
