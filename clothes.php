...
<head>
    ...
    <link rel="stylesheet" href="donate/clothes.css">
    <link rel="website icon" type="png" href="./images/icon.png">
    <title>Aid Alliance | Clothes donation</title>
...
<body>
   ...
   <!-- <div class="donate-home">
    ...
    <div class="titlediv">
        <h1 class="titlehead">CLOTHES</h1>
    </div>

    <section>
        <div class="donate-class">

            <form action="catogories-function/clothesfunction.php" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="inputBox">
                            ...
                            <input type="text" placeholder="S, L, XL" name="description" required>
                        </div>
                    
                        <div class="inputBox">
                            <span>Clothes for Gender :</span>
        ...
        <div class="container">
            <div class="row">
                <div class="footer-col">
                    <h4>Aid Alliance</h4>
                    <ul>
                        <li><a href="index.phpm #about">about us</a></li>
