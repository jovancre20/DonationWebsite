...
<head>
    ...
    <title>Aid Alliance | Thank You</title>
</head>
...
<body>
    ...
    <section class="write" id="write">
        <header class="header1">
            <p>Thank you for Donation!<br>
            We are deeply grateful for your generous donation. Your contribution will make a significant impact on our <br> cause and help us continue our mission. Your support means the world to us, and we can't thank you <br> enough for your kindness and generosity. With your help, we can work towards a brighter future. <br>Thank you from the bottom of our hearts</p>
        </header>
    </section>
    <!-- Bottom Footer-->
    <footer class="footer">
