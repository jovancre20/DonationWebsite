...
<head>
    ...
    <title>Aid Alliance | Stationary Donation</title>
...
<body>
   ...
   <!-- <div class="donate-home">
    ...
    <div class="titlediv">
        <h1 class="titlehead">Stationary Donaiton</h1>
    </div>

    <section>
        <div class="donate-class">

            <form action="catogories-function/stationaryfunction.php" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="inputBox">
                            <span>Type of Stationary :</span>
                            <input type="text" placeholder="Books, pencil, eraser, etc.." name="type" required>
                        </div>
                        <div class="inputBox">
